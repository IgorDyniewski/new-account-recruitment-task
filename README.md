...
2. Clone this repo using: `git clone https://github.com/IgorDyniewski/new-account-recruitment-task.git`
3. Move to the appropriate directory: `cd new-account-recruitment-task`
4. Run `yarn` 
5. Run  `yarn start`
